	...
	function showOption(obj){
		...
		id : id
			...
			for ( var option in data) {
				...
				content += "<td><a href='productOption?method=updateUI&id="+data[option].id+"'>修改</a></td>";
				content += "<td><a href='javascript:void(0)' onclick='delete1("+data[option].id+")'>删除</a></td></tr>";
...
<body>
	<div class="container">
		...
		<div class="form-groupcol-md-12">
				<div class="col-md-offset-2col-md-10">${param.status==1?"<div class='alert alert-danger' role='alert'>修改选项成功</div>":"" }
				</div>
			</div>
	</div>
	<script type="text/javascript">
		function delete1(id){
			if(confirm("你确定要删除吗")){
				location.href="productOption?method=delete&id="+id;
			}
		}
	</script>
</body>
