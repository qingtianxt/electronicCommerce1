...
-->
	<div class="container">
		...
		<form id="myForm" role="form" action="productOption?method=add"
			method="post">
			...
			<div class="form-groupcol-md-12">
				<div class="col-md-offset-2col-md-10">${param.status==1?"<div class='alert alert-danger' role='alert'>添加选项成功</div>":"" }
				</div>
			</div>
