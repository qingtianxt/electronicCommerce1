...
/static/bootstrap-3.3.5-dist/css/bootstrap.css" />
<style type="text/css">
.code {
		...
		<div class="col-md-4">
			<form role="form" class="form-horizontal"
				...
				<div class="form-group">
					...
					<div class="col-md-3">
						<a href="${pageContext.request.contextPath }/user?method=addUI">注册账号</a>
					</div>
				</div>
				<div class="form-group">
...
"
	...
	<script
		src="${pageContext.request.contextPath}/static/bootstrap-3.3.5-dis
t/js/bootstrap.js"
		type="text/javascript"></script>
	<script
		src="${pageContext.request.contextPath}/static/js/jquery.validate.
js"
		type="text/javascript"></script>
	<script
